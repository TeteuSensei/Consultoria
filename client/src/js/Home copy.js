    ...
    <div className="home">
      ...
      <section className="banner">
        <div className="banner-content">
          ...
          <p>
            Na LWA - Live With an Athlete, oferecemos uma abordagem
            personalizada para alcançar seus objetivos de saúde e bem-estar.
            Combinando tecnologia avançada, profissionais qualificados e suporte
            contínuo, fornecemos tudo que você precisa para transformar sua
            vida.
          </p>
      ...
      <section className="testimonials">
        ...
        <div className="testimonial-cards">
          ...
          <div className="testimonial-card">
            ...
            <p>"Consultoria excelente, me ajudou a alcançar todos os meus objetivos!"</p>
